...
<div class="container">
    <h1 class="mt-4 mb-4">Leave Management</h1>

    <!-- Button group for CRUD operations -->
    <div class="btn-group">
        <button type="button" class="btn btn-success" data-toggle="modal" onclick="openAddEmployeeModal()" data-target="#addEmployeeModal">Add Leave</button>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addEmployeeModalLabel">Add Leave</h5>
            ...
            <div class="modal-body">
                ...
                <form id="addEmployeeForm" action="<%= request.getContextPath() %>/EmployeeServlet?action=add" method="POST">
                    <div class="form-group" style="display:none" >
                        ...
                        <input type="text" value="asdasdadas" class="form-control" id="firstName" name="firstName" required>
                    </div>
                    <div class="form-group" style="display:none">
                        <label for="lastName">Last Name:</label>
                        <input type="text" value="asdasd" class="form-control" id="lastName" name="lastName" required>
                    </div>
                    <div class="form-group">
                        <label for="dob">Leave date:</label>
                    ...
                    <div class="form-group" style="display:none">
                        ...
                        <input type="email" value="employee@employee.com"  class="form-control" id="email" name="email" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="display:none">
                        ...
                        <input type="password" value="asa"  class="form-control" id="password" name="password" required>
                    </div>
                    <div class="form-group">
                        <label for="jobTitle">Reason:</label>
...
<div class="modal fade" id="updateEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="updateEmployeeModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateEmployeeModalLabel">Update Leave</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form id="updateEmployeeForm">
                    ...
                    <div class="form-group">
                        <label for="updateDob">Leave Date:</label>
                    ...
                    <div class="form-group">
                        <label for="updateJobTitle">Reason :</label>
